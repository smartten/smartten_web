...
function ContactUs({ languages }) {
  ...
  return (
    <div className="contact-us">
      <BlogBanner
        title="Contact Us"
        backgroundName="banner-contact.jpg"
          ...
          <Fade left>
            <div className="info-text col-md-6 col-sm-12 col-12">
              <div className="text-item">
                <h2>{languages.title_phone}</h2>
                <a href="/tel:2462593698">+(84) 24 6259 3698</a>
              </div>
              <div className="text-item">
              ...
              <div className="text-item">
                ...
                <a href="mailto:info@smartten.com.vn">info@smartten.com.vn</a>
              </div>
            </div>
          </Fade>
          <Fade right>
      ...
      <div className="container">
        <div className="contact-us-input">
          ...
          <Fade right>
            <form
              ref={form}
              className="input-form col-md-6 col-sm-12 col-12"
              method="post"
            ...
            >
              ...
              <div className="form-group">
                <input
                  ...
                  placeholder={languages.your_name}
                  name="name"
                  id="name"
                  required
                />
              ...
              <div className="form-group">
                <input
                  ...
                  type="email"
                  className="form-control "
                  placeholder={languages.your_email}
                  name="email"
                  id="email"
                  required
                />
              ...
              <div className="form-group">
                <input
                  ...
                  pattern="[0-9]{10}"
                  className="form-control "
                  placeholder={languages.your_mobile}
                  name="mobile"
                  id="mobile"
                  required
                />
              ...
              <div className="form-group">
                <textarea
                  ...
                  rows="5"
                  className="form-control "
                  placeholder={languages.your_message}
                  name="message"
                  id="message"
                  required
                ></textarea>
              ...
              <div className="form-group button">
                <button className=" btn_black btn_m3" type="submit">
                  Send
                </button>
                <div id="alert_msg">{alertMessage}</div>
              </div>
            </form>
          </Fade>
        </div>
