...
import { HomeContent, HomeContentLink } from "../../assets/context";
    ...
    <div className="home">
      <div className="bannerContent">
        <Fade left>
          <h1 className="homeMainHead col-md-5 col-sm-8 col-8">
            <span className="homeHead">
              <span className="headLight">Driving the Power of</span>
              DIGITAL
            </span>
          </h1>
        </Fade>
        <figure className="col-md-8 col-sm-12 col-12">
          <img
            src={require("../../assets/images/banner-home.jpeg")}
            className="bannerImg loading"
            alt="Home Banner: Driving Next-Gen Digital"
            height="50"
            width="50"
                ...
                <div className="col-md-6 col-12 port_sec_right">
                  <div className="title-headline ">
                    ...
                    <p style={{ fontWeight: "600" }}>
                      SMARTTEN – Agile Development Company
                    </p>
        ...
        <div className="container">
          <Fade bottom>
            <div className="services-title">
              <h2>Our Services</h2>
              <p>
                At Smartten, we primarily focus on adding extra value to your
                business by using up-to-date Technologies, which results in
                higher profitability & company evaluation.
              </p>
            </div>
          </Fade>
          <Fade left>
            <div className="services-list">
              <div className="col-md-4 col-sm-6 col-12">
                <div className="service-item">
                  ...
                  <img
                    src={require("../../assets/images/Smartten-Services-1000-6.jpeg")}
                    alt=" "
                  />
              ...
              <div className="col-md-4 col-sm-6 col-12">
                <div className="service-item">
                  ...
                  <img
                    src={require("../../assets/images/Smartten-Services-1000-3.jpeg")}
                    alt=" "
                  />
              ...
              <div className="col-md-4 col-sm-6 col-12">
                <div className="service-item">
                  ...
                  <p>
                    Being the top 30 Global App Developers, Smartten has immense
                    experience creating feature-rich & high-performing Mobile
                    Apps for iOS and Android platforms.
                  </p>
                  <img
                    src={require("../../assets/images/Smartten-Services-1000-1.jpeg")}
                    alt=" "
                  />
              ...
              <div className="col-md-4 col-sm-6 col-12">
                <div className="service-item">
                  ...
                  <img
                    src={require("../../assets/images/Smartten-Services-1000-5.jpeg")}
                    alt=" "
                  />
                  <Link to="/services/quality-assurance-and-testing">
                    <i className="ti ti-arrow-right"></i>
                  </Link>
                </div>
              </div>
              <div className="col-md-4 col-sm-6 col-12">
                <div className="service-item">
                  ...
                  <img
                    src={require("../../assets/images/Smartten-Services-1000-4.jpeg")}
                    alt=" "
                  />
              ...
              <div className="col-md-4 col-sm-6 col-12">
                <div className="service-item">
                  ...
                  <img
                    src={require("../../assets/images/Smartten-Services-1000-2.jpeg")}
                    alt=" "
                  />
                  <Link to="/">
                    <i className="ti ti-arrow-right"></i>
        ...
        <div className="container">
          ...
          <div className="m-timeline-wrap">
            <div className="m-timeline-row">
              <div className="m-timeline-col">
                <span className="timeline-circel borderAn">
                  01<span className="timeline-circel-inr fillAn ">01</span>{" "}
                </span>
                <div className="timeline-content">
                  <h4>Discovery</h4>
                  <p>
                    Discussing mission, requirements, vision, and documentation
                    with our clients.
                  </p>
                </div>
              </div>
              <div className="m-timeline-col">
                <span className="timeline-circel borderAn">
                  02<span className="timeline-circel-inr fillAn ">02</span>{" "}
                </span>
                <div className="timeline-content">
                  <h4>Planning</h4>
                  <p>
                    We set up the formative designs that supports the software
                    usability and findability of its information.
                  </p>
                </div>
              </div>
              <div className="m-timeline-col">
                <span className="timeline-circel borderAn">
                  03<span className="timeline-circel-inr fillAn ">03</span>{" "}
                </span>
                <div className="timeline-content">
                  <h4>Design</h4>
                  <p>
                    Creating designs to sustain software usability, while
                    finding the capacity of its statistics.
                  </p>
                </div>
              </div>
              <div className="m-timeline-col">
                <span className="timeline-circel borderAn">
                  04<span className="timeline-circel-inr fillAn ">04</span>{" "}
                </span>
                <div className="timeline-content">
                  <h4>Development</h4>
                  <p>
                    Our software team starts the coding process; building,
                    documenting, implementing and test web and mobile apps.
                  </p>
                </div>
              </div>
              <div className="m-timeline-col">
                <span className="timeline-circel borderAn">
                  05<span className="timeline-circel-inr fillAn ">05</span>{" "}
                </span>
                <div className="timeline-content">
                  <h4>Testing – QA – Launch</h4>
                  <p>
                    Checking the apps for gaps and bugs to rid the same if any.
                  </p>
                </div>
              </div>
              <div className="m-timeline-col">
                <span className="timeline-circel borderAn">
                  06<span className="timeline-circel-inr fillAn">06</span>{" "}
                </span>
                <div className="timeline-content">
                  <h4>Maintenance</h4>
                  <p>
                    Once Applications are launched, SMARTTEN keeps the Apps
                    updated through innovative programs and processes.{" "}
                  </p>
                </div>
              </div>
            </div>
            <div className="btn-holder text-center">
              <button className="btn blue-border-btn btn-sm timeline-show-link">
                View More
              </button>
            </div>
          </div>
          <div className="timeline-row d-lg-flex d-md-none d-sm-none d-none">
            <div className="col-md-2 timeline-col upper">
              <div className="timeline-circel-outer">
                <span className="timeline-circel-line">
                  <span className="timeline-circel-line-inr lineAn anClass"></span>{" "}
                </span>{" "}
                <span className="timeline-circel borderAn">
                  01
                  <span className="timeline-circel-inr fillAn anClass">
                    01
                  </span>{" "}
                </span>
              </div>
              <div className="timeline-content timeline-upper-content">
                <h4>Discovery</h4>
                <p>
                  First, we’ll take a deep dive into your documentation,
                  requirements, business objectives and goals.
                </p>
              </div>
            ...
            <div className="col-md-2 timeline-col bottom">
              <div className="timeline-circel-outer">
                <span className="timeline-circel-line">
                  {" "}
                  <span className="timeline-circel-line-inr lineAn anClass">
                    {" "}
                  </span>{" "}
                </span>{" "}
                <span className="timeline-circel borderAn">
                  02
                  <span
                    className="timeline-circel-inr fillAn   anClass"
                    data--delay="2s"
                  >
                    02
                  </span>{" "}
              ...
              <div className="timeline-content timeline-bottom-content">
                <h4>Planning</h4>
                <p>
                  Next, we’ll perform a comprehensive analysis and planning that
                  serves as the foundation for the project.
                </p>
              </div>
              <div className="middleline">
                <div className="middleline-inr middlelineAn "></div>
            ...
            <div className="col-md-2 timeline-col upper">
              ...
              <div className="timeline-content timeline-upper-content">
                <h4>Design</h4>
                <p>
                  Now, we’ll create a structural design that supports the
                  software usability and findability of its information.
                </p>
              </div>
              <div className="middleline">
                <div className="middleline-inr middlelineAn "></div>
            ...
            <div className="col-md-2 timeline-col bottom">
              ...
              <div className="timeline-content timeline-bottom-content">
                <h4>Development</h4>
                <p>
                  Let the coding begin! In this phase, our software engineers
                  build, implement, test, and document.
                </p>
              </div>
              <div className="middleline">
                <div className="middleline-inr middlelineAn "></div>
            ...
            <div className="col-md-2 timeline-col upper">
              <div className="timeline-circel-outer">
                ...
                <span className="timeline-circel">
                  05
                  <span className="timeline-circel-inr fillAn anClass">
                    05
                  </span>{" "}
              ...
              <div className="timeline-content timeline-upper-content">
                <h4>Testing – QA – Launch</h4>
                <p>
                  To confirm there are no bugs or gaps, everything goes through
                  an intensive testing procedure.
                </p>
              </div>
              <div className="middleline">
                <div className="middleline-inr middlelineAn "></div>
            ...
            <div className="col-md-2 timeline-col bottom">
              ...
              <div className="timeline-content timeline-bottom-content">
                <h4>Maintenance</h4>
                <p>
                  Post-launch, we offer programs to ensure your software is
                  always up-to-date.
                </p>
              </div>
            </div>
            ...
            <div className="col-md-4 col-sm-6 col-12 mb-30">
              <div className="service2-item-box text-center">
                ...
                <div className="service2-text">
                  ...
                  <p className="white">
                    We do it all. Top to Bottom. Front to Back.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="col-md-4 col-sm-6 col-12 mb-30">
              <div className="service2-item-box text-center">
                ...
                <div className="service2-text">
                  ...
                  <p className="white">
                    We create light-weight, high-speed software
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="col-md-4 col-sm-6 col-12 mb-30">
              <div className="service2-item-box text-center">
                ...
                <div className="service2-text">
                  ...
                  <p className="white">
                    Mobile is the future... We design for it
                  </p>
                </div>
              </div>
            </div>
