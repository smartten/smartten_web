              ...
              <div className="col-md-10 col-sm-12 col-12 mx-auto "  >
							<div className="testimonial-info">
								<span>
									<span>
										<span>
											<p>SMARTTEN is a truly professional company. They have helped our company get to a new level of service excellence!</p>
              ...
              <div className="col-md-10 col-sm-12 col-12 mx-auto "  >
							<div className="testimonial-info">
								<span>
									<span>
										<span>
											<p>Flexibility and on-time delivery. SMARTTEN team has strong technical experience and execution capabilities.</p>
											<div className="test-info">
              ...
              <div className="col-md-10 col-sm-12 col-12 mx-auto "  >
							<div className="testimonial-info">
								<span>
									<span>
										<span>
											<p>SMARTTEN came in and saved the day! They are very easy to work with, and very understanding of changes as the project moved along.</p>
											<div className="test-info">
